...
![Product Cards](Sketches/01.2-product-cards.excalidraw)
...
| Property | Value |
|----------|-------|
| Component | Body Text (medium weight) |
...
| Property | Value |
|----------|-------|
| Component | Card (elevated, rounded) |
...
| Border radius | 12px |
| Shadow | subtle elevation (card-shadow token) |
| Min width | 260px (mobile) |
...
| Property | Value |
|----------|-------|
| Component | Image (responsive, centered) |
...
| Property | Value |
|----------|-------|
| Component | H3 Heading (condensed, bold) |
...
| Property | Value |
|----------|-------|
| Component | Body Text (muted, small) |
...
| Property | Value |
|----------|-------|
| Component | Mini Slider (green gradient) |
...
| Property | Value |
|----------|-------|
| Component | Mini Slider (amber gradient) |
...
| Property | Value |
|----------|-------|
| Component | Mini Slider (blue/info gradient) |
...
| Property | Value |
|----------|-------|
| Component | Price Display (large, bold) |
...
| Property | Value |
|----------|-------|
| Component | Badge (status color) |
| Translation Key | `card.stock` |
| Variants | See table below |

| Variant | Color | NO | EN |
|---------|-------|----|----|
| In stock | success (#51cf66) | "Pa lager" | "In stock" |
| Low stock | warning (#fcc419) | "Fa igjen" | "Low stock" |
| Out of stock | text-muted (#868e96) | "Ikke pa lager" | "Out of stock" |
...
|---|----------|---------|--------|
| 1 | Card tap target — full card or dedicated button? | Full card is easier on mobile but may conflict with swipe gesture | 🔴 Open |
