...
> **Component note:** The tire card CTA is a reusable component — it will appear on any page that lists products (results, store page, collections, related products). Its in-cart state and remove behavior are part of the component spec, not this page alone. When extracted to the design system, it should live under `D-Design-System/molecules/tire-card-cta.md`.
