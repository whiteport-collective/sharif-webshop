...
Continuous parallax surface — this view slides up over the results. The page heading appears first, followed by a compact product summary, shop selector (three options including home delivery), order summary, and sticky CTA.

```
+──────────────────────────+
│  ← Tilbake               │  ← Header (Back left, service buttons top-right fixed)
│                          │
│  Hvor vil du montere?    │  ← H1 Page Heading
│                          │
│  ┌────────────────────┐  │
│  │ 4 ST Powertrac     │  │  ← Compact product summary
│  │ Adamas H/P         │  │    (no image — text only)
│  │ 185/65R15          │  │
│  │ 499 kr/stk · 1 996 │  │
│  └────────────────────┘  │
│                          │
│  ┌────────────────────┐  │
│  │ ● Fjellhamar       │  │  ← Shop card (selected, red border)
│  │   Kloppaveien 16,  │  │
│  │   1472 Fjellhamar  │  │
│  │   ✓ Plenty of slots│  │
│  │     this week      │  │
│  └────────────────────┘  │
│  ┌────────────────────┐  │
│  │   Drammen          │  │  ← Shop card (unselected)
│  │   Tordenskiolds    │  │
│  │   gate 73, Drammen │  │
│  │   Slots available  │  │
│  └────────────────────┘  │
│  ┌────────────────────┐  │
│  │   Home delivery    │  │  ← Home delivery option
│  │   Deliver to your  │  │
│  │   door anywhere    │  │    "From 700 kr" right-aligned
│  │   [Add postal code]│  │  ← Sub-link to enter postal code
│  └────────────────────┘  │
│                          │
│  ┌────────────────────┐  │
│  │ Your order         │  │  ← Order summary
│  │ 4x Powertrac  1 996│  │    Product + total right-aligned
│  │ Mounting incl. /   │  │
│  │   Fjellhamar       │  │
│  └────────────────────┘  │
│                          │
...
|---------|----------|------|--------|----------|
| Page heading ("Hvor vil du montere?") | H1 | text-2xl / text-3xl | bold | display |
...
| Shop card name | p | text-md | semibold | default |
| Shop card address | p | text-sm | normal | default |
| Availability hint | p | text-xs | medium | default |
| Home delivery price ("Fra 700 kr") | p | text-sm | semibold | default |
| Home delivery postal link | a | text-xs | normal | default |
| Order summary label ("Din bestilling") | p | text-xs | normal | default — muted |
| Order summary product + total | p | text-sm | normal / bold | default |
| Order summary mounting location | p | text-xs | normal | default — muted |
...
**OBJECT ID:** `dm-page-heading`

| Property | Value |
|----------|-------|
| Semantic | H1 |
| Purpose | First element after the header — frames the one decision left to make |
| Component | [Heading](../../../D-Design-System/00-design-system.md#heading) |
| Translation Key | `dm.page.heading` |
| NO | "Hvor vil du montere?" |
| EN | "Where to get them mounted?" |
...
| Property | Value |
|----------|-------|
| Purpose | Let Harriet pick where to get tires mounted — two physical shops + home delivery |
| Element gap | space-md |
| Note | No separate section heading needed — page H1 frames the decision |
...
| EN | "Slots available" |
| Color | success |
| Note | Shorter than Fjellhamar's availability hint — differentiated to avoid identical-looking cards |

---

#### Shop Card: Home Delivery

**OBJECT ID:** `dm-shop-home-delivery`

| Property | Value |
|----------|-------|
| Component | [Selectable Card](../../../D-Design-System/00-design-system.md#selectable-card) |
| Purpose | Home delivery option — tires shipped directly to Harriet's door |
| Behavior | onTap → select home delivery, deselect shop, reveal postal code input, update order summary |
| Default state | Unselected |
| Border | `border-width-strong` + brand-primary when selected, border-default when unselected |
| Border radius | `radius-md` |
| Padding | space-lg |
...
**OBJECT ID:** `dm-shop-home-delivery-name`

| Property | Value |
|----------|-------|
| Component | [Text](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.shop.home_delivery.name` |
| NO | "Hjemlevering" |
| EN | "Home delivery" |

##### Home Delivery Description

**OBJECT ID:** `dm-shop-home-delivery-desc`

| Property | Value |
|----------|-------|
| Component | [Text (muted)](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.shop.home_delivery.desc` |
| NO | "Leverer til din dør overalt i Norge. Fraktkostnad legges til." |
| EN | "Deliver to your door anywhere in Norway. Shipping cost is added." |

##### Home Delivery Price

**OBJECT ID:** `dm-shop-home-delivery-price`

| Property | Value |
|----------|-------|
| Component | [Text](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.shop.home_delivery.price` |
| NO | "Fra 700 kr" |
| EN | "From 700 kr" |
| Layout | Right-aligned, same row as the description text block |

##### Home Delivery Postal Code Link

**OBJECT ID:** `dm-shop-home-delivery-postal`

| Property | Value |
|----------|-------|
| Component | [Text Link](../../../D-Design-System/00-design-system.md#text-link) |
| Translation Key | `dm.shop.home_delivery.postal_link` |
| NO | "Legg til postnummer" |
| EN | "Add your postal code" |
| Behavior | onTap → expand inline postal code input field |
| Visibility | Only when home delivery is selected |
...
| Layout | Two rows: (1) product name left + total right-aligned; (2) mounting location below |

---

#### Summary Label

**OBJECT ID:** `dm-summary-label`

| Property | Value |
|----------|-------|
| Component | [Text (muted, small)](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.summary.label` |
| NO | "Din bestilling" |
| EN | "Your order" |
...
Layout: horizontal, space-between. Product name on the left, total on the right.

##### Summary Product Name

**OBJECT ID:** `dm-summary-product`

| Property | Value |
|----------|-------|
| Component | [Text](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.summary.product` |
| NO | "{Quantity}x {Brand} {Model}" (e.g., "4x Powertrac Adamas H/P") |
| EN | "{Quantity}x {Brand} {Model}" |
...
| Property | Value |
|----------|-------|
| Component | [Text (bold)](../../../D-Design-System/00-design-system.md#text) |
| Translation Key | `dm.summary.total` |
| NO | "{Total} kr" (e.g., "1 996 kr") |
| EN | "{Total} kr" |
| Layout | Right-aligned, same row as product name |
| Behavior | Updates live when quantity or shop changes |
...
| NO | "Montering inkl. / {Shop}" (e.g., "Montering inkl. / Fjellhamar") |
| EN | "Mounting incl. / {Shop}" |
...
|-----------|------|---------|-----------------|
| `dm-page-heading` | H1 | Page Heading | `dm.page.heading` |
...
| `dm-shop-home-delivery` | Interactive | Shop Selector | — |
| `dm-shop-home-delivery-name` | Text | Shop Selector | `dm.shop.home_delivery.name` |
| `dm-shop-home-delivery-desc` | Text | Shop Selector | `dm.shop.home_delivery.desc` |
| `dm-shop-home-delivery-price` | Text | Shop Selector | `dm.shop.home_delivery.price` |
| `dm-shop-home-delivery-postal` | Interactive | Shop Selector | `dm.shop.home_delivery.postal_link` |
| `dm-order-summary` | Section | Order Summary | — |
| `dm-summary-label` | Text | Order Summary | `dm.summary.label` |
| `dm-summary-product` | Text | Order Summary | `dm.summary.product` |
...
```
Mobile screen. Header: back arrow left, service buttons (language "NO", cart) fixed top-right.

Large H1 heading: "Where to get them mounted?"

Compact product summary (no image, text only): "4 ST Powertrac Adamas H/P" / "185/65R15" / "499 kr/stk · 1 996 kr"

Three selectable shop cards stacked vertically:
1. "Fjellhamar" — address "Kloppaveien 16, 1472 Fjellhamar", green text "Plenty of slots this week". Selected state: red/brand border.
2. "Drammen" — address "Tordenskiolds gate 73, Drammen", green text "Slots available". Not selected.
3. "Home delivery" — body text "Deliver to your door anywhere in Norway. Shipping cost is added." with "From 700 kr" right-aligned. Small link below: "Add your postal code". Not selected.

Order summary box: "Your order" label small muted text. Next row: "4x Powertrac Adamas H/P" left + "1 996 kr" right-aligned bold. Row below: "Mounting incl. / Fjellhamar" muted small.

Full-width red CTA button at bottom: "Pay now -- 1 996 kr"
```
