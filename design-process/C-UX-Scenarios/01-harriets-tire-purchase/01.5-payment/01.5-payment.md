...
![Payment](Sketches/01.5-payment.jpg)
...
| Component | External embed or redirect |
...
| Property | Value |
|----------|-------|
| Component | Data object (passed to provider, not rendered by Sharif) |
...
| Property | Value |
|----------|-------|
| Component | URL parameter (passed to provider) |
...
|---|----------|---------|--------|
| 1 | Klarna or Qliro -- which provider for POC? | Both support Norwegian market. Klarna has sandbox. | Open |
| 2 | Embedded checkout or full redirect? | Embedded keeps Sharif header visible but adds complexity | Open |
| 3 | What order data format does the provider require? | Affects API integration layer | Open |
