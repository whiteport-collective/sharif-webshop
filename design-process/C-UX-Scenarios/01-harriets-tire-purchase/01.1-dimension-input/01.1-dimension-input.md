...
![Dimension Input](Sketches/01.1-dimension-input.excalidraw)
...
| Property | Value |
|----------|-------|
| Component | Text Link (brand-primary) |
...
| Property | Value |
|----------|-------|
| Component | Body text (muted, small, centered) |
